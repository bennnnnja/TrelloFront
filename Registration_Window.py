...
class Registration_Window:
    ...
    def create_buttons(self):
        # создаем кнопки
        button1 = ctk.CTkButton(self.app, corner_radius= 15, bg_color = '#689AD3', fg_color= '#2c4663', text="ОК", width=100, height=25, font=("Arial", 14), command=self.save_registrtation_window)
        button2 = ctk.CTkButton(self.app, corner_radius= 15, bg_color = '#689AD3', fg_color= '#2c4663', text="Отмена", width=100, height=25, font=("Arial", 14), command=self.close_registration_window)
